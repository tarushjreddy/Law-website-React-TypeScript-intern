...
import AddLargeIcon from "../../../../../../../../assets/icons/verbalComp/addLarge.png";
import CheckIcon from "../../../../../../../../assets/icons/verbalComp/check.png";
    ...
    <div id="upload-box" style={{ margin: "10px" }}>
      <div className={classes.root}>
        ...
        <label htmlFor={`icon-button-file-${id}`}>
          ...
          />
          {file.name && (
            <span style={{ fontSize: "1em" }}>{file.name.slice(0, 25)}</span>
          )}
        </label>
        {file.name && (
          <img
